...
const GA_MEASUREMENT_ID = 'G-0KDYK4LLQC';
...
export const metadata: Metadata = {
  ...
  keywords: [
    'alfaiataria pinhais',
    'terno sob medida pinhais',
    'uniforme empresarial personalizado',
    'alfaiataria pineville',
    'ajuste de terno pinhais',
  ],
  openGraph: {
    title: site.seo.titulo,
    description: site.seo.descricao,
  ...
  verification: {
    google: 'fc8k-oADzdYqfbA8A6J5bYu56rTSPzjwUtSUIbSm9mk',
  },
};
